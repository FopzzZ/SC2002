...
/**
* ModifyMovieMenuUI is an entity containing the user interface for an admin to modify movies
*/
public class ModifyMovieMenuUI {
    ...
    /** 
     * A method to display the menu for creating movie listings
     */
    ...
    /** 
     * A method to display the menu for updating movie listings
     */
    ...
    /** 
     * A method to display the menu for removing movie lisings
     */
